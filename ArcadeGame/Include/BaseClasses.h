...
*		Applies PIMPL idiom as demonstration
*
*		NOTE: As this ia a base class, it has not inherited from
*		any other class such as Sprite. This would mean an object
*		such as a CONTROLLABLE PLAYER CHARACTER SPRITE would need
*		to inherit from this class AND others...
*/
class Controllable
{
	private:
